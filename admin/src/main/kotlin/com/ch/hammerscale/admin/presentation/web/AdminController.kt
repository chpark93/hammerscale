package com.ch.hammerscale.admin.presentation.web

import com.ch.hammerscale.admin.domain.model.abuse.BlockedBy
...
import com.ch.hammerscale.admin.presentation.dto.*
...
class AdminController(
    ...
    fun blockClient(
        ...
        val expiresAt = request.durationMinutes?.let {
            Instant.now().plusSeconds(it * 60L)
        }
