...
class UserExposedAdapter : UserRepository {
    ...
    private fun ResultRow.toUser(): User = User(
        ...
        createdAt = this[Users.createdAt].atZone(ZoneId.systemDefault()).toInstant(),
        updatedAt = this[Users.updatedAt].atZone(ZoneId.systemDefault()).toInstant()
    )
}
