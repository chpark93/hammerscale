package com.ch.hammerscale.control.infrastructure.persistence.table
...
object TestPlans : Table("test_plans") {
    ...
    val testType = varchar("test_type", 10).default("LOAD")
    val virtualUsers = integer("virtual_users").default(0)
    val durationSeconds = integer("duration_seconds").default(0)
    val rampUpSeconds = integer("ramp_up_seconds").default(0)
