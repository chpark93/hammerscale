...
import com.ch.hammerscale.control.application.DashboardService
import com.project.common.api.ApiResponse
import com.ch.hammerscale.control.presentation.test.dto.TestAnalysis
import com.ch.hammerscale.control.presentation.test.dto.TestSummary
...
class DashboardController(
    ...
    fun streamMetrics(
        ...
        emitters.computeIfAbsent(testId) {
